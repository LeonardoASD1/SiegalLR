 ...
 * @author leori
 */
public class SucursalAgregar extends javax.swing.JInternalFrame {

SucursalAdmin ss;
public SucursalAgregar (SucursalAdmin ss) {
    initComponents();
    this.ss = ss;
}
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nombre Sucursal");

        jLabel5.setText("Direccion");

        jLabel6.setText("Telefono");

        jLabel7.setText("Es Matriz?");
